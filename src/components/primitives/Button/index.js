...
const Loading = ({
  ...
  return (
    <button
      disabled
      type="button"
      className={`text-${color.toLowerCase()} bg-${bgColor} w-${width} hover:bg-${bgHoverColor} font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800`}
    >
      <svg
        aria-hidden="true"
        role="status"
